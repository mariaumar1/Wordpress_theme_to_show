...
<main class="main archive_tours">
    <div class="container">
        <div class="tour-posts">
            <?php $args = array( 'post_type' => 'tours','posts_per_page' => -1, 'order' => 'asc');
                        ...
                        <div class="trip-detail-info">
                            <h2><?php the_title(); ?></h2>
                                ...
                                <div class="Season bottom-line">
                                    <p class="line_img"><span class="line_img_span"><span class="line_img_span"><i class="far fa-calendar-alt"></i></span> Season: <span><?php the_field('season'); ?></span></p>
                                </div>
