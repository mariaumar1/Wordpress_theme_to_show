<?php /* Template Name: Advanture Tab */ ?>
<?php get_header(); ?>
...
<!-- ================================== -->
    <section class="page_tabs">
        <div class="container">
            <h1 class="heading_with_bottom_line">Find Your Trip</h1>
            <ul id="tabs" class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a id="tab-A" href="#pane-A" class="nav-link active" data-toggle="tab" role="tab">Adventures</a>
                </li>
                <li class="nav-item">
                    <a id="tab-B" href="#pane-B" class="nav-link" data-toggle="tab" role="tab">Destinations</a>
                </li>
            </ul>
        </div>
<!-- ======tab-content===========start=============== -->
