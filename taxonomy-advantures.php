...
<main class="main advanture_archive">
    <div class="container">    
        ...
        <div class="tour-posts">
            ...
            $args = array( 'post_type' => 'tours','posts_per_page' => -1, 'order' => 'asc', 'tax_query' => array(array('taxonomy' => 'advantures','field' => 'slug','terms' => $al_cat_slug)));
                    ...
                    <div class="trip-info">
                        ...
                        <div class="trip-detail-info">
                            <h2><?php the_title(); ?></h2>
                              ...
                              <!--   <div class="book_now">
                                    <a class="book_now_btn btn btn-secondary btn-block" href="#"  target="_blank">Book Now</a>
                                </div> -->
                                <div class="book_now">
